...
$string['customexport'] = 'Custom range (must be between {$a->timestart} - {$a->timeend})';
$string['customexportfrom'] = 'From';
$string['customexportto'] = 'To';
$string['daily'] = 'Daily';
$string['day'] = 'Day';
...
$string['errorinvalidexportstartdate'] = 'You cannot export calendar events before this date.';
$string['errorinvalidexportenddate'] = 'You cannot export calendar events after this date.';
$string['errorinvalidexportdateorder'] = 'The start date must be earlier than end date.';
