...
$string['errorinvalidexportstartdate'] = 'You cannot export calendar events before {$a}.';
$string['errorinvalidexportenddate'] = 'You cannot export calendar events after {$a}.';
