...
class lib_test extends \advanced_testcase {
    ...
    public function test_label_get_label_name(string $name, string $content, string $format, string $expectedname): void {
        ...
        // To test with empty label name, we need to reset the label name to the test dataset value after module creation,
        // because the module creation process autofill it with a default value if it is empty.
        $label->name = $name;
        $coursemodule = get_coursemodule_from_instance('label', $label->id, $course->id);
        $label->coursemodule = $coursemodule->id;
