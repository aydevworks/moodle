...
class mod_lti_mod_form extends moodleform_mod {
    ...
    /**
     * Defines the form for manual instances.
     *
     * @return void
     * @throws coding_exception
     * @throws moodle_exception
     */
    protected function manual_instance_form() {
        global $PAGE, $OUTPUT, $COURSE;

        $showoptions = has_capability('mod/lti:addcoursetool', $this->context);
